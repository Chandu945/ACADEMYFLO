    ...
    const moduleFixture = await Test.createTestingModule({
      ...
      providers: [
        ...
        },
        {
          ...
          useFactory: (sr: SubscriptionRepository, audit: AuditRecorderPort) =>
            new SetSubscriptionManualUseCase(sr, audit),
          inject: [SUBSCRIPTION_REPOSITORY, AUDIT_RECORDER_PORT],
        },
        {
          provide: 'DEACTIVATE_SUBSCRIPTION_USE_CASE',
          useFactory: (sr: SubscriptionRepository, audit: AuditRecorderPort) =>
            new DeactivateSubscriptionUseCase(sr, audit),
          inject: [SUBSCRIPTION_REPOSITORY, AUDIT_RECORDER_PORT],
        },
        {
        ...
        },
        {
          ...
          ) => new ResetOwnerPasswordUseCase(ur, sr, ar, h, pg, audit, dtr),
          inject: [
            USER_REPOSITORY,
            SESSION_REPOSITORY,
            ACADEMY_REPOSITORY,
