  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (
        ...
        feeDueRepo: FeeDueRepository,
        auditRecorder: AuditRecorderPort,
      ) => new RunMonthlyDuesEngineUseCase(academyRepo, studentRepo, feeDueRepo, auditRecorder),
      inject: [ACADEMY_REPOSITORY, STUDENT_REPOSITORY, FEE_DUE_REPOSITORY, AUDIT_RECORDER_PORT],
    },
  ],
