/**
 * Fetch policy for admin-web BFF.
 * Adds timeout + safe retry for idempotent GET requests only.
 */
...
/**
 * Safe GET fetch with timeout + one retry on network errors.
 */
...
/**
 * Non-retryable fetch with timeout for POST/PUT/PATCH/DELETE.
 */
